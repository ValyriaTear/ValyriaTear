...
function _CreateEvents()
    ...
    event = vt_map.MapTransitionEvent.Create("to forest crystal", "dat/maps/layna_forest/layna_forest_crystal_map.lua",
    ...
    event = vt_map.ScriptedEvent.Create("to 1-1", "to_1_1", "a_to_b_update");


    event = vt_map.ScriptedEvent.Create("to 1-2", "to_1_2", "a_to_b_update");


    event = vt_map.ScriptedEvent.Create("to 2-1", "to_2_1", "a_to_b_update");


    event = vt_map.ScriptedEvent.Create("to 2-2", "to_2_2", "a_to_b_update");


    event = vt_map.ScriptedEvent.Create("to 3-1", "to_3_1", "a_to_b_update");


    event = vt_map.ScriptedEvent.Create("to 3-2", "to_3_2", "a_to_b_update");


    event = vt_map.ScriptedEvent.Create("to 4-1", "to_4_1", "a_to_b_update");


    event = vt_map.ScriptedEvent.Create("to 4-2", "to_4_2", "a_to_b_update");


    event = vt_map.ScriptedEvent.Create("to 5-1", "to_5_1", "a_to_b_update");


    event = vt_map.ScriptedEvent.Create("to 5-2", "to_5_2", "a_to_b_update");


    event = vt_map.ScriptedEvent.Create("to 6-1", "to_6_1", "a_to_b_update");


    event = vt_map.ScriptedEvent.Create("to 6-2", "to_6_2", "a_to_b_update");


    event = vt_map.ScriptedEvent.Create("to 7-1", "to_7_1", "a_to_b_update");


    event = vt_map.ScriptedEvent.Create("to 7-2", "to_7_2", "a_to_b_update");


    event = vt_map.ScriptedEvent.Create("to 8-1", "to_8_1", "a_to_b_update");


    event = vt_map.ScriptedEvent.Create("to 8-2", "to_8_2", "a_to_b_update");


    event = vt_map.ScriptedEvent.Create("to 9-1", "to_9_1", "a_to_b_update");


    event = vt_map.ScriptedEvent.Create("to 9-2", "to_9_2", "a_to_b_update");
