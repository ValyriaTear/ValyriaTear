...
function _CreateEvents()
    ...
    event = hoa_map.MapTransitionEvent("to Village riverbank", "dat/maps/layna_village/layna_village_riverbank_map.lua",
                                       "dat/maps/layna_village/layna_village_riverbank_script.lua", "from_village_south");
    EventManager:RegisterEvent(event);

    event = hoa_map.MapTransitionEvent("to left house", "dat/maps/layna_village/layna_village_south_entrance_left_house_map.lua",
                                       "dat/maps/layna_village/layna_village_south_entrance_left_house_script.lua", "from_village_south");
    EventManager:RegisterEvent(event);

    event = hoa_map.MapTransitionEvent("to right house", "dat/maps/layna_village/layna_village_south_entrance_right_house_map.lua",
