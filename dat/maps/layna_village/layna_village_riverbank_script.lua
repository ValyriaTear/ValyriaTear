...
function _CreateEvents()
    ...
    event = hoa_map.MapTransitionEvent("to Riverbank house", "dat/maps/layna_village/layna_village_riverbank_house_map.lua",
                                       "dat/maps/layna_village/layna_village_riverbank_house_script.lua", "from_riverbank");
    EventManager:RegisterEvent(event);

    event = hoa_map.MapTransitionEvent("to secret path entrance", "dat/maps/layna_village/layna_village_center_map.lua",
