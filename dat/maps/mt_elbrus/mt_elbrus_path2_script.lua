...
function _CreateEvents()
    ...
    -- To the first cave
    event = vt_map.MapTransitionEvent.Create("to cave 2-1", "dat/maps/mt_elbrus/mt_elbrus_cave2_map.lua",
                                       "dat/maps/mt_elbrus/mt_elbrus_cave2_script.lua", "from_elbrus_entrance2-1");

    event = vt_map.MapTransitionEvent.Create("to cave 2-2", "dat/maps/mt_elbrus/mt_elbrus_cave2_map.lua",
                                       "dat/maps/mt_elbrus/mt_elbrus_cave2_script.lua", "from_elbrus_entrance2-2");

    event = vt_map.MapTransitionEvent.Create("to cave 3-1", "dat/maps/mt_elbrus/mt_elbrus_cave3_map.lua",
                                       "dat/maps/mt_elbrus/mt_elbrus_cave3_script.lua", "from_elbrus_entrance3-1");

    event = vt_map.MapTransitionEvent.Create("to cave 3-2", "dat/maps/mt_elbrus/mt_elbrus_cave3_map.lua",
                                       "dat/maps/mt_elbrus/mt_elbrus_cave3_script.lua", "from_elbrus_entrance3-2");


    event = vt_map.MapTransitionEvent.Create("to mountain path 3", "dat/maps/mt_elbrus/mt_elbrus_path3_map.lua",
                                       "dat/maps/mt_elbrus/mt_elbrus_path3_script.lua", "from_path2");

    event = vt_map.MapTransitionEvent.Create("to mountain path 3bis", "dat/maps/mt_elbrus/mt_elbrus_path3_map.lua",
                                       "dat/maps/mt_elbrus/mt_elbrus_path3_script.lua", "from_path2_chest");

    event = vt_map.MapTransitionEvent.Create("to mountain path 1", "dat/maps/mt_elbrus/mt_elbrus_path1_map.lua",
