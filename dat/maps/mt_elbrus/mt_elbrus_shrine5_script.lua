...
function _CreateObjects()
    ...
    event = vt_map.ScriptedEvent.Create("Open Gate", "open_gate_animated_start", "open_gate_animated_update")
...
function _CreateEvents()
    ...
    event = vt_map.MapTransitionEvent.Create("to mountain shrine 2nd floor", "dat/maps/mt_elbrus/mt_elbrus_shrine_stairs_map.lua",
                                       "dat/maps/mt_elbrus/mt_elbrus_shrine_stairs_script.lua", "from_shrine_first_floor");


    event = vt_map.MapTransitionEvent.Create("to mountain shrine 1st floor SW room - left door", "dat/maps/mt_elbrus/mt_elbrus_shrine6_map.lua",
                                       "dat/maps/mt_elbrus/mt_elbrus_shrine6_script.lua", "from_shrine_first_floor_NW_left_door");

    event = vt_map.MapTransitionEvent.Create("to mountain shrine 1st floor SW room - right door", "dat/maps/mt_elbrus/mt_elbrus_shrine6_map.lua",
    ...
    event = vt_map.LookAtSpriteEvent.Create("Bronann looks at Orlinn", hero, orlinn);


    -- Opens the left passage to the next map.
    event = vt_map.ScriptedEvent.Create("Open south west passage", "open_sw_passage_start", "open_sw_passage_update");
    ...
    event = vt_map.DialogueEvent.Create("Ready? dialogue", dialogue);
    ...
    -- Common event end
    event = vt_map.ScriptedEvent.Create("Thrown to high passage event end", "thrown_to_passage_event_end", "");
    ...
    event = vt_map.DialogueEvent.Create("Orlinn comes back dialogue", dialogue);


    -- Chose "No"
    event = vt_map.ScriptedEvent.Create("Not coming back event", "not_coming_back_event_end", "");
    ...
    event = vt_map.ScriptedEvent.Create("Bronann falls on ground", "bronann_on_ground_animation", "");
    ...
    event = vt_map.ScriptedEvent.Create("Orlinn comes back event end", "come_back_from_passage_event_end", "");
