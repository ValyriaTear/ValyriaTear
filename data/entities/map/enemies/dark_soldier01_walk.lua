...
sprite_animation = {
	...
	image_filename = "data/entities/map/enemies/dark_soldier01_spritesheet.png",
    ...
    frames = {
        ...
        [ANIM_EAST] = {
            ...
            [2] = { id = 13, duration = 150 },
            [3] = { id = 15, duration = 150 },
            [4] = { id = 16, duration = 150 },
            [5] = { id = 15, duration = 150 }
        },
        [ANIM_WEST] = {
            [0] = { id = 19, duration = 150 },
            [1] = { id = 20, duration = 150 },
            [2] = { id = 19, duration = 150 },
            [3] = { id = 21, duration = 150 },
            [4] = { id = 22, duration = 150 },
            [5] = { id = 21, duration = 150 }
        }
    }
}
