...
skill_graph = {
	...
	[4] = {
		...
		-- Experience points cost needed to reach this node
		experience_points_needed = 790,
		-- Skill id learned when reaching this node
		skill_id_learned = 10003,
		-- items needed to reach this node
		items_needed = {
			[3004] = 10,
		},
