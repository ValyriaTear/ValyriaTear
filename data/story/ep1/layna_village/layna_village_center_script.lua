...
function _CreateEvents()
    ...
    -- Triggered Events
    vt_map.MapTransitionEvent.Create("to Bronann's home", "data/story/ep1/layna_village/layna_village_bronanns_home_map.lua",
                                     "data/story/ep1/layna_village/layna_village_bronanns_home_script.lua", "from_village_center");

    vt_map.MapTransitionEvent.Create("to Riverbank", "data/story/ep1/layna_village/layna_village_riverbank_map.lua",
                                     "data/story/ep1/layna_village/layna_village_riverbank_script.lua", "from_village_center");

    vt_map.MapTransitionEvent.Create("to Village south entrance", "data/story/ep1/layna_village/layna_village_south_entrance_map.lua",
                                     "data/story/ep1/layna_village/layna_village_south_entrance_script.lua", "from_village_center");

    vt_map.MapTransitionEvent.Create("to Kalya house path", "data/story/ep1/layna_village/layna_village_kalya_house_path_map.lua",
                                     "data/story/ep1/layna_village/layna_village_kalya_house_path_script.lua", "from_village_center");

    vt_map.MapTransitionEvent.Create("to Flora's Shop", "data/story/ep1/layna_village/layna_village_center_shop_map.lua",
                                     "data/story/ep1/layna_village/layna_village_center_shop_script.lua", "from_village_center");

    vt_map.MapTransitionEvent.Create("to sophia house", "data/story/ep1/layna_village/layna_village_center_sophia_house_map.lua",
                                     "data/story/ep1/layna_village/layna_village_center_sophia_house_script.lua", "from_village_center");

    vt_map.MapTransitionEvent.Create("to secret cliff", "data/story/ep1/layna_village/layna_village_riverbank_map.lua",
                                     "data/story/ep1/layna_village/layna_village_riverbank_script.lua", "from_secret_path");

    vt_map.MapTransitionEvent.Create("to layna forest entrance", "data/story/ep1/layna_forest/layna_forest_entrance_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_entrance_script.lua", "from_village_center")

    event = vt_map.MapTransitionEvent.Create("To well underground", "data/story/ep1/layna_village/layna_village_well_underground_map.lua",
        "data/story/ep1/layna_village/layna_village_well_underground_script.lua",
        "from layna village")
