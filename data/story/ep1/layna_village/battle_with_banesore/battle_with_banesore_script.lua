...
function Initialize(battle_instance)
    ...
    soldier = Script:CreateAnimation("data/story/ep1/layna_village/battle_with_banesore/battle_dark_soldier_idle_down.lua");
    soldier:SetDimensions(150.0, 150.0);
    lilly = Script:CreateAnimation("data/story/ep1/layna_village/battle_with_banesore/battle_lilly_idle_down.lua");
...
function Update()
    ...
    if (dialogue3_done == true and DialogueManager:IsDialogueActive() == false) then
        if (herth_walking == nil) then
            ...
            herth_walking = Script:CreateAnimation("data/story/ep1/layna_village/battle_with_banesore/herth_walking.lua");
