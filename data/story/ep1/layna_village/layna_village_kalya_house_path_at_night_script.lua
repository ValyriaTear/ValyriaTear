...
function _CreateEvents()
    ...
    vt_map.MapTransitionEvent.Create("to Kalya's house", "data/story/ep1/layna_village/layna_village_kalya_house_map.lua",
                                     "data/story/ep1/layna_village/layna_village_kalya_house_script.lua", "from_kalya_house_path");
end
