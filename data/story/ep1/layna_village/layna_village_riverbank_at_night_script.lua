...
function Load(m)
    ...
    -- Event Scripts
    Script:AddScript("data/story/ep1/layna_village/battle_with_banesore/show_crystals_script.lua");
    Script:AddScript("data/story/ep1/layna_village/battle_with_banesore/show_smoke_cloud_script.lua");
...
function _CreateCharacters()
    ...
    if (GlobalManager:GetMapData():GetPreviousLocation() == "from_village_south") then
        bronann:SetPosition(117, 18);
        bronann:SetDirection(vt_map.MapMode.WEST);
    end

    if (GlobalManager:GetMapData():GetPreviousLocation() == "from_secret_path") then
        bronann:SetPosition(65, 4);
        bronann:SetDirection(vt_map.MapMode.SOUTH);
    end

    if (GlobalManager:GetMapData():GetPreviousLocation() == "from_riverbank_house") then
...
function _CreateEvents()
    ...
    vt_map.MapTransitionEvent.Create("to Village center", "data/story/ep1/layna_village/layna_village_center_map.lua",
                                       "data/story/ep1/layna_village/layna_village_center_at_night_script.lua", "from_riverbank");
    ...
    vt_map.MapTransitionEvent.Create("Restart map", "data/story/ep1/layna_village/layna_village_riverbank_map.lua",
                                     "data/story/ep1/layna_village/layna_village_riverbank_at_night_script.lua", "from_village_center");
    ...
    event:SetBoss(true);
    event:AddScript("data/story/ep1/layna_village/battle_with_banesore/battle_with_banesore_script.lua");
    ...
    vt_map.MapTransitionEvent.Create("To Kalya house path scene", "data/story/ep1/layna_village/layna_village_kalya_house_path_map.lua",
                                     "data/story/ep1/layna_village/layna_village_kalya_house_path_at_night_script.lua", "from_riverbank_at_night_scene");
end
