...
function _CreateEvents()
    -- Triggered events
    vt_map.MapTransitionEvent.Create("exit floor", "data/story/ep1/layna_village/layna_village_kalya_house_path_map.lua",
                                     "data/story/ep1/layna_village/layna_village_kalya_house_path_script.lua", "from grandma house");
end
