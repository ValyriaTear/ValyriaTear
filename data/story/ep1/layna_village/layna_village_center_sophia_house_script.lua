...
function _CreateEvents()
    ...
    -- Triggered events
    vt_map.MapTransitionEvent.Create("exit floor", "data/story/ep1/layna_village/layna_village_center_map.lua",
                                     "data/story/ep1/layna_village/layna_village_center_script.lua", "from sophia's house");
end
