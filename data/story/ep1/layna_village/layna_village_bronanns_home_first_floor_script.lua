...
function Load(m)
    ...
    Map:GetScriptSupervisor():AddScript("data/story/ep1/layna_village/in_game_move_and_interact_anim.lua");
...
function _CreateEvents()
    ...
    -- Triggered events
    vt_map.MapTransitionEvent.Create("exit floor", "data/story/ep1/layna_village/layna_village_bronanns_home_map.lua",
                                     "data/story/ep1/layna_village/layna_village_bronanns_home_script.lua", "From Bronann's first floor");
