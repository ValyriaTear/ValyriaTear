...
function _CreateEvents()
    ...
    vt_map.MapTransitionEvent.Create("to Village center", "data/story/ep1/layna_village/layna_village_center_map.lua",
                                     "data/story/ep1/layna_village/layna_village_center_script.lua", "from_riverbank");
    ...
    vt_map.MapTransitionEvent.Create("to Village south entrance", "data/story/ep1/layna_village/layna_village_south_entrance_map.lua",
                                     "data/story/ep1/layna_village/layna_village_south_entrance_script.lua", "from_riverbank");

    vt_map.MapTransitionEvent.Create("to Riverbank house", "data/story/ep1/layna_village/layna_village_riverbank_house_map.lua",
                                     "data/story/ep1/layna_village/layna_village_riverbank_house_script.lua", "from_riverbank");

    vt_map.MapTransitionEvent.Create("to secret path entrance", "data/story/ep1/layna_village/layna_village_center_map.lua",
                                     "data/story/ep1/layna_village/layna_village_center_script.lua", "from_secret_path");
