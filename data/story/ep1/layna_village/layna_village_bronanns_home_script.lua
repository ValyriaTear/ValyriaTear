...
function _CreateEvents()
    ...
    -- Triggered Events
    vt_map.MapTransitionEvent.Create("to village", "data/story/ep1/layna_village/layna_village_center_map.lua",
                                     "data/story/ep1/layna_village/layna_village_center_script.lua", "from_bronanns_home");

    vt_map.MapTransitionEvent.Create("to Bronann's 1st floor", "data/story/ep1/layna_village/layna_village_bronanns_home_first_floor_map.lua",
                                     "data/story/ep1/layna_village/layna_village_bronanns_home_first_floor_script.lua", "from_bronanns_home");
