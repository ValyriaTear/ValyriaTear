...
function Load(m)
    ...
    Map:SetMinimapImage("data/story/ep1/layna_forest/minimaps/layna_forest_south_east_minimap.png");
...
function _CreateCharacters()
    ...
    elseif (GlobalManager:GetMapData():GetPreviousLocation() == "from layna forest cave 2") then
        hero:SetDirection(vt_map.MapMode.SOUTH);
...
function _CreateEvents()
    ...
    vt_map.MapTransitionEvent.Create("to forest NE", "data/story/ep1/layna_forest/layna_forest_north_east_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_north_east_script.lua", "from forest SE")

    vt_map.MapTransitionEvent.Create("to forest SW", "data/story/ep1/layna_forest/layna_forest_south_west_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_south_west_script.lua", "from forest SE")

    vt_map.MapTransitionEvent.Create("to cave 1_2", "data/story/ep1/layna_forest/layna_forest_cave1_2_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_cave1_2_script.lua", "from forest SE")

    vt_map.MapTransitionEvent.Create("to wolf cave", "data/story/ep1/layna_forest/layna_forest_wolf_cave_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_wolf_cave_script.lua", "from forest SE")

    vt_map.MapTransitionEvent.Create("to cave 2", "data/story/ep1/layna_forest/layna_forest_cave2_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_cave2_script.lua", "from forest SE")
