...
function Load(m)
    ...
    Map:SetMinimapImage("data/story/ep1/layna_forest/minimaps/layna_forest_cave1_2_minimap.png");
    ...
    Map:GetScriptSupervisor():AddScript("data/story/ep1/layna_forest/layna_forest_caves_background_anim.lua");

    -- The script file which will handle the display of the stone sign image.
    Map:GetScriptSupervisor():AddScript("data/story/ep1/layna_forest/layna_forest_cave1_2_stone_sign_image.lua");
end
...
function _CreateObjects()
    ...
    vt_map.Halo.Create("data/visuals/lights/torch_light_mask.lua", 113, 109,
            vt_video.Color(light_color_red, light_color_green, light_color_blue, light_color_alpha));
    vt_map.Halo.Create("data/visuals/lights/torch_light_mask.lua", 0, 18,
            vt_video.Color(light_color_red, light_color_green, light_color_blue, light_color_alpha));

    -- Add different halo light, representing holes of light coming from the ceiling
    vt_map.Halo.Create("data/visuals/lights/right_ray_light.lua", 23, 17,
            vt_video.Color(light_color_red, light_color_green, light_color_blue, light_color_alpha));
    vt_map.Halo.Create("data/visuals/lights/right_ray_light.lua", 15, 50,
            vt_video.Color(light_color_red, light_color_green, light_color_blue, light_color_alpha));
    vt_map.Halo.Create("data/visuals/lights/right_ray_light.lua", 37, 84,
            vt_video.Color(light_color_red, light_color_green, light_color_blue, light_color_alpha));
...
function _CreateEvents()
    ...
    vt_map.MapTransitionEvent.Create("to cave 1-1", "data/story/ep1/layna_forest/layna_forest_cave1_1_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_cave1_1_script.lua", "from_layna_cave_1_2");

    vt_map.MapTransitionEvent.Create("to south east exit", "data/story/ep1/layna_forest/layna_forest_south_east_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_south_east_script.lua", "from_layna_cave_1_2");

    vt_map.MapTransitionEvent.Create("to wolf cave", "data/story/ep1/layna_forest/layna_forest_wolf_cave_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_wolf_cave_script.lua",  "from_layna_cave_1_2");
