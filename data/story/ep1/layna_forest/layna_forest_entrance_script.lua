...
function Load(m)
    ...
    if (GlobalManager:GetGameEvents():DoesEventExist("story", "kalya_save_points_n_spring_speech_done") == false) then
        ...
        GlobalManager:GetWorldMapData():SetWorldLocationVisible("layna forest", true);
    end
...
function _CreateEvents()
    ...
    -- Triggered events
    vt_map.MapTransitionEvent.Create("exit forest", "data/story/ep1/layna_village/layna_village_center_map.lua",
                                     "data/story/ep1/layna_village/layna_village_center_script.lua", "from_layna_forest_entrance");

    vt_map.MapTransitionEvent.Create("to forest NW", "data/story/ep1/layna_forest/layna_forest_north_west_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_north_west_script.lua", "from_layna_forest_entrance");

    -- After the forest dungeon
    vt_map.MapTransitionEvent.Create("exit forest at night", "data/story/ep1/layna_village/layna_village_center_map.lua",
                                     "data/story/ep1/layna_village/layna_village_center_at_night_script.lua", "from_layna_forest_entrance");
