...
function Load(m)
    ...
    Map:SetMinimapImage("data/story/ep1/layna_forest/minimaps/layna_forest_wolf_cave_minimap.png");
...
function _CreateObjects()
    ...
    necklace:AddAnimation("data/story/ep1/layna_forest/wolfpain_necklace.lua");
...
function _CreateEvents()
    ...
    vt_map.MapTransitionEvent.Create("to cave 1-2", "data/story/ep1/layna_forest/layna_forest_cave1_2_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_cave1_2_script.lua", "from_layna_wolf_cave");

    vt_map.MapTransitionEvent.Create("to south east exit", "data/story/ep1/layna_forest/layna_forest_south_east_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_south_east_script.lua", "from_layna_wolf_cave");
