...
function Load(m)
    ...
    Map:SetMinimapImage("data/story/ep1/layna_forest/minimaps/layna_forest_north_west_minimap.png");
...
function _CreateCharacters()
    ...
    if (GlobalManager:GetMapData():GetPreviousLocation() == "from_layna_forest_NE") then
        hero:SetPosition(124, 42);
        hero:SetDirection(vt_map.MapMode.WEST);
    elseif (GlobalManager:GetMapData():GetPreviousLocation() == "from forest SW") then
        hero:SetPosition(116, 94);
        hero:SetDirection(vt_map.MapMode.NORTH);
    elseif (GlobalManager:GetMapData():GetPreviousLocation() == "from_layna_cave_entrance") then
...
function _CreateObjects()
    ...
    if (GlobalManager:GetGameEvents():GetEventValue("story", "layna_forest_crystal_event_done") == 1) then
        ...
        event:AddScript("data/story/ep1/layna_forest/after_crystal_twilight_battles.lua");
        if (GlobalManager:GetGameEvents():GetEventValue("story", "layna_forest_twilight_value") > 2) then
...
function _CreateEvents()
    ...
    vt_map.MapTransitionEvent.Create("to forest entrance", "data/story/ep1/layna_forest/layna_forest_entrance_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_entrance_script.lua", "from_layna_forest_NW");

    vt_map.MapTransitionEvent.Create("to forest NE", "data/story/ep1/layna_forest/layna_forest_north_east_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_north_east_script.lua", "from_layna_forest_NW");

    vt_map.MapTransitionEvent.Create("to forest SW", "data/story/ep1/layna_forest/layna_forest_south_west_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_south_west_script.lua", "from_layna_forest_NW");

    vt_map.MapTransitionEvent.Create("to cave entrance", "data/story/ep1/layna_forest/layna_forest_cave1_1_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_cave1_1_script.lua", "from_layna_forest_NW");
...
function _SetBattleEnvironment(enemy)
    ...
    if (GlobalManager:GetGameEvents():GetEventValue("story", "layna_forest_crystal_event_done") == 1) then
        -- Setup time of the day lighting on battles
        enemy:AddBattleScript("data/story/ep1/layna_forest/after_crystal_twilight_battles.lua");
        if (GlobalManager:GetGameEvents():GetEventValue("story", "layna_forest_twilight_value") > 2) then
