...
function _CreateObjects()
    ...
    chest1:AddItem(1, 2) -- Tiny Potion
    chest1:AddItem(11, 2) -- Tiny Moon Juice Potion
end
...
function _CreateEvents()
    ...
    vt_map.MapTransitionEvent.Create("to forest SE", "data/story/ep1/layna_forest/layna_forest_south_east_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_south_east_script.lua", "from layna forest cave 2")

    vt_map.MapTransitionEvent.Create("to forest crystal", "data/story/ep1/layna_forest/layna_forest_crystal_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_crystal_script.lua", "from layna forest cave 2")
