...
function Load(m)
    ...
    Map:SetMinimapImage("data/story/ep1/layna_forest/minimaps/layna_forest_south_west_minimap.png");
...
function _CreateEvents()
    ...
    vt_map.MapTransitionEvent.Create("to forest SE", "data/story/ep1/layna_forest/layna_forest_south_east_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_south_east_script.lua", "from forest SW");

    vt_map.MapTransitionEvent.Create("to forest NW", "data/story/ep1/layna_forest/layna_forest_north_west_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_north_west_script.lua", "from forest SW");
