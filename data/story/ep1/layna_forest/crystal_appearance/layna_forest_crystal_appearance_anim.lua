...
function Initialize(map_instance)
    ...
    crystal_shadow = Script:CreateImage("data/story/ep1/layna_forest/crystal_appearance/crystal_shadow.png");
    crystal_shadow:SetDimensions(20.0, 31.0);

    lightning1 = Script:CreateImage("data/story/ep1/layna_forest/crystal_appearance/blue_lightning1.png");
    lightning1:SetDimensions(248.0, 400.0);
    lightning2 = Script:CreateImage("data/story/ep1/layna_forest/crystal_appearance/blue_lightning2.png");
    lightning2:SetDimensions(118.0, 400.0);
    lightning3 = Script:CreateImage("data/story/ep1/layna_forest/crystal_appearance/blue_lightning3.png");
    lightning3:SetDimensions(171.0, 400.0);

    vortex = Script:CreateImage("data/story/ep1/layna_forest/crystal_appearance/vortex.png");
