...
function _CreateEvents()
    ...
    vt_map.MapTransitionEvent.Create("to forest NW", "data/story/ep1/layna_forest/layna_forest_north_west_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_north_west_script.lua", "from_layna_cave_entrance");

    vt_map.MapTransitionEvent.Create("to cave 1-2", "data/story/ep1/layna_forest/layna_forest_cave1_2_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_cave1_2_script.lua", "from_layna_cave_entrance");
