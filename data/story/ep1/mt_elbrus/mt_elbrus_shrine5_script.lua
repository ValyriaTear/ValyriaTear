...
function _CreateEvents()
    ...
    vt_map.MapTransitionEvent.Create("to mountain shrine main room", "data/story/ep1/mt_elbrus/mt_elbrus_shrine2_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine2_script.lua", "from_shrine_first_floor");

    vt_map.MapTransitionEvent.Create("to mountain shrine main room-waterfalls", "data/story/ep1/mt_elbrus/mt_elbrus_shrine2_2_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine2_script.lua", "from_shrine_first_floor");

    vt_map.MapTransitionEvent.Create("to mountain shrine 2nd floor", "data/story/ep1/mt_elbrus/mt_elbrus_shrine_stairs_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine_stairs_script.lua", "from_shrine_first_floor");

    vt_map.MapTransitionEvent.Create("to mountain shrine 1st floor SW room - left door", "data/story/ep1/mt_elbrus/mt_elbrus_shrine6_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine6_script.lua", "from_shrine_first_floor_NW_left_door");

    vt_map.MapTransitionEvent.Create("to mountain shrine 1st floor SW room - right door", "data/story/ep1/mt_elbrus/mt_elbrus_shrine6_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine6_script.lua", "from_shrine_first_floor_NW_right_door");

    vt_map.MapTransitionEvent.Create("to mountain shrine 1st floor NE room", "data/story/ep1/mt_elbrus/mt_elbrus_shrine8_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine8_script.lua", "from_shrine_first_floor_NW_room");
