...
function _CreateEvents()
    ...
    vt_map.MapTransitionEvent.Create("to mountain path 2", "data/story/ep1/mt_elbrus/mt_elbrus_path2_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_path2_script.lua", "from_path3");

    vt_map.MapTransitionEvent.Create("to mountain path 2bis", "data/story/ep1/mt_elbrus/mt_elbrus_path2_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_path2_script.lua", "from_path3_chest");

    vt_map.MapTransitionEvent.Create("to mountain path 4", "data/story/ep1/mt_elbrus/mt_elbrus_path4_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_path4_script.lua", "from_path3");
