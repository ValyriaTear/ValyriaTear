...
function _CreateEvents()
    -- To the first cave
    vt_map.MapTransitionEvent.Create("to exit 1", "data/story/ep1/mt_elbrus/mt_elbrus_path1_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_path1_script.lua", "from_grotto_exit1");

    vt_map.MapTransitionEvent.Create("to exit 2", "data/story/ep1/mt_elbrus/mt_elbrus_path1_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_path1_script.lua", "from_grotto_exit2");

    vt_map.MapTransitionEvent.Create("to exit 3", "data/story/ep1/mt_elbrus/mt_elbrus_path1_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_path1_script.lua", "from_grotto_exit3");

    vt_map.MapTransitionEvent.Create("to exit 4", "data/story/ep1/mt_elbrus/mt_elbrus_path1_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_path1_script.lua", "from_grotto_exit4");
end
