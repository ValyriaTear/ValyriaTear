...
function _CreateEvents()
    ...
    vt_map.MapTransitionEvent.Create("to mountain shrine 1st floor NW room", "data/story/ep1/mt_elbrus/mt_elbrus_shrine5_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine5_script.lua", "from_shrine_first_floor_NE_room");

    vt_map.MapTransitionEvent.Create("to mountain shrine 1st floor SE room", "data/story/ep1/mt_elbrus/mt_elbrus_shrine7_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine7_script.lua", "from_shrine_first_floor_NE_room");
    ...
    vt_map.MapTransitionEvent.Create("to previous entrance", "data/story/ep1/mt_elbrus/mt_elbrus_shrine8_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine8_script.lua", GlobalManager:GetMapData():GetPreviousLocation());
