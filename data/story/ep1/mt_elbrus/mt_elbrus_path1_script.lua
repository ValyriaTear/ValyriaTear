...
function _CreateEnemies()
    ...
    dark_soldier1:AddBattleScript("data/story/ep1/mt_elbrus/battle_with_dark_soldiers_script.lua");
    ...
    -- Add special timer script
    enemy:AddBattleScript("data/story/ep1/mt_elbrus/battle_with_dark_soldiers_script.lua");
    enemy:SetBoss(true);
...
function _CreateEvents()
    ...
    -- To the first cave
    vt_map.MapTransitionEvent.Create("to cave 1", "data/story/ep1/mt_elbrus/mt_elbrus_cave1_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_cave1_script.lua", "from_entrance1");

    vt_map.MapTransitionEvent.Create("to cave 2", "data/story/ep1/mt_elbrus/mt_elbrus_cave1_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_cave1_script.lua", "from_entrance2");

    vt_map.MapTransitionEvent.Create("to cave 3", "data/story/ep1/mt_elbrus/mt_elbrus_cave1_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_cave1_script.lua", "from_entrance3");

    vt_map.MapTransitionEvent.Create("to cave 4", "data/story/ep1/mt_elbrus/mt_elbrus_cave1_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_cave1_script.lua", "from_entrance4");

    vt_map.MapTransitionEvent.Create("to mountain path 2", "data/story/ep1/mt_elbrus/mt_elbrus_path2_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_path2_script.lua", "from_path1");
