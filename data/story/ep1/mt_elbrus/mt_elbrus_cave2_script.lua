...
function _CreateCharacters()
    ...
    if (GlobalManager:GetMapData():GetPreviousLocation() == "from_elbrus_entrance2-2") then
        hero:SetDirection(vt_map.MapMode.NORTH);
...
function _CreateEvents()
    vt_map.MapTransitionEvent.Create("to exit 2-1", "data/story/ep1/mt_elbrus/mt_elbrus_path2_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_path2_script.lua", "from_grotto2_1_exit");

    vt_map.MapTransitionEvent.Create("to exit 2-2", "data/story/ep1/mt_elbrus/mt_elbrus_path2_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_path2_script.lua", "from_grotto2_2_exit");
end
