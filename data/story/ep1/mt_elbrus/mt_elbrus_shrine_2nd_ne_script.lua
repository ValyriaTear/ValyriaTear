...
function _CreateObjects()
    -- Snow effect
    vt_map.ParticleObject.Create("data/story/ep1/mt_elbrus/particles_snow_south_entrance.lua", 28, 40, vt_map.MapMode.GROUND_OBJECT);
...
function _CreateEvents()
    vt_map.MapTransitionEvent.Create("to mountain shrine 1st floor", "data/story/ep1/mt_elbrus/mt_elbrus_shrine_stairs_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine_stairs_script.lua", "from_shrine_2nd_floor");

    vt_map.MapTransitionEvent.Create("to mountain shrine 2nd floor South", "data/story/ep1/mt_elbrus/mt_elbrus_shrine_2nd_s1_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine_2nd_s1_script.lua", "from_shrine_2nd_floor_NE_room");
