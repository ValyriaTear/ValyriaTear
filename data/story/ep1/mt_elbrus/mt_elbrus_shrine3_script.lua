...
function _CreateObjects()
    ...
    spike_wall:AddStillFrame("data/story/ep1/mt_elbrus/spike_wall.png");
...
function _CreateEvents()
    ...
    vt_map.MapTransitionEvent.Create("to mountain shrine main room", "data/story/ep1/mt_elbrus/mt_elbrus_shrine2_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine2_script.lua", "from_shrine_trap_room");
    ...
    vt_map.MapTransitionEvent.Create("to mountain shrine treasure room", "data/story/ep1/mt_elbrus/mt_elbrus_shrine9_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine9_script.lua", "from_shrine_trap_room");
...
function _SetBattleEnvironment(enemy)
    ...
    enemy:AddBattleScript("data/story/ep1/mt_elbrus/battles_in_trap_map_script.lua");
end
