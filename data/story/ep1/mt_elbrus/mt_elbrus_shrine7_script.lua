...
function _CreateEvents()
    ...
    vt_map.MapTransitionEvent.Create("to mountain shrine 1st floor SW room - top door", "data/story/ep1/mt_elbrus/mt_elbrus_shrine6_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine6_script.lua", "from_shrine_first_floor_SE_top_door");

    vt_map.MapTransitionEvent.Create("to mountain shrine 1st floor SW room - bottom door", "data/story/ep1/mt_elbrus/mt_elbrus_shrine6_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine6_script.lua", "from_shrine_first_floor_SE_bottom_door");

    vt_map.MapTransitionEvent.Create("to mountain shrine 1st floor NE room", "data/story/ep1/mt_elbrus/mt_elbrus_shrine8_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine8_script.lua", "from_shrine_first_floor_SE_room");
