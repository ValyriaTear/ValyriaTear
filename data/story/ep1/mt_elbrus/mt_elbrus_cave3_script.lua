...
function _CreateObjects()
    ...
    -- exit 1
    vt_map.Halo.Create("data/visuals/lights/torch_light_mask.lua", 4.5, 29,
        vt_video.Color(0.3, 0.3, 0.46, 0.8));
    -- exit 2
    vt_map.Halo.Create("data/visuals/lights/torch_light_mask.lua", 52, 22,
        vt_video.Color(0.3, 0.3, 0.46, 0.8));
    ...
    vt_map.ScriptedEvent.Create("Check trigger1", "check_trigger1", "")
    ...
    vt_map.ScriptedEvent.Create("Check trigger2", "check_trigger2", "")
...
function _CreateEvents()
    vt_map.MapTransitionEvent.Create("to exit 3-1", "data/story/ep1/mt_elbrus/mt_elbrus_path2_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_path2_script.lua", "from_grotto3_1_exit");

    vt_map.MapTransitionEvent.Create("to exit 3-2", "data/story/ep1/mt_elbrus/mt_elbrus_path2_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_path2_script.lua", "from_grotto3_2_exit");
end
