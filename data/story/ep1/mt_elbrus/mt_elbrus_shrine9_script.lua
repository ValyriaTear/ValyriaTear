...
function _CreateObjects()
    ...
    falling_hole:AddStillFrame("data/story/ep1/mt_elbrus/falling_hole.png");
    ...
    falling_hole_wall:AddStillFrame("data/story/ep1/mt_elbrus/falling_hole_above.png");
...
function _CreateEvents()
    ...
    vt_map.MapTransitionEvent.Create("to mountain shrine entrance", "data/story/ep1/mt_elbrus/mt_elbrus_shrine2_2_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine2_script.lua", "from_shrine_stairs1");

    vt_map.MapTransitionEvent.Create("to mountain shrine trap room", "data/story/ep1/mt_elbrus/mt_elbrus_shrine3_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine3_script.lua", "from_shrine_treasure_room");
    ...
    vt_map.MapTransitionEvent.Create("to mountain shrine basement", "data/story/ep1/mt_elbrus/mt_elbrus_shrine_basement_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine_basement_script.lua", "from_shrine_stairs1");
end
