...
function _CreateEvents()
    ...
    -- To the first cave
    vt_map.MapTransitionEvent.Create("to cave 2-1", "data/story/ep1/mt_elbrus/mt_elbrus_cave2_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_cave2_script.lua", "from_elbrus_entrance2-1");

    vt_map.MapTransitionEvent.Create("to cave 2-2", "data/story/ep1/mt_elbrus/mt_elbrus_cave2_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_cave2_script.lua", "from_elbrus_entrance2-2");

    vt_map.MapTransitionEvent.Create("to cave 3-1", "data/story/ep1/mt_elbrus/mt_elbrus_cave3_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_cave3_script.lua", "from_elbrus_entrance3-1");

    vt_map.MapTransitionEvent.Create("to cave 3-2", "data/story/ep1/mt_elbrus/mt_elbrus_cave3_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_cave3_script.lua", "from_elbrus_entrance3-2");

    vt_map.MapTransitionEvent.Create("to mountain path 3", "data/story/ep1/mt_elbrus/mt_elbrus_path3_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_path3_script.lua", "from_path2");

    vt_map.MapTransitionEvent.Create("to mountain path 3bis", "data/story/ep1/mt_elbrus/mt_elbrus_path3_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_path3_script.lua", "from_path2_chest");

    vt_map.MapTransitionEvent.Create("to mountain path 1", "data/story/ep1/mt_elbrus/mt_elbrus_path1_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_path1_script.lua", "from_path2");
    ...
    kalya_move_next_to_bronann_event:AddEventLinkAtEnd("Bronann looks north");
    kalya_move_next_to_bronann_event:AddEventLinkAtEnd("Kalya talks about the rain");
    ...
    event:AddEventLinkAtEnd("End of rain dialogue");
