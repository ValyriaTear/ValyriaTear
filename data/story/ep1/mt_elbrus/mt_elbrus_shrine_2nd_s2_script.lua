...
function _CreateObjects()
    ...
    -- Snow effects
    vt_map.ParticleObject.Create("data/story/ep1/mt_elbrus/particles_snow_south_entrance.lua", 16, 72, vt_map.MapMode.GROUND_OBJECT);
    vt_map.Halo.Create("data/visuals/lights/torch_light_mask.lua", 16, 79,
                vt_video.Color(1.0, 1.0, 1.0, 0.8));

    vt_map.ParticleObject.Create("data/story/ep1/mt_elbrus/particles_snow_south_entrance.lua", 50, 50, vt_map.MapMode.GROUND_OBJECT);
...
function _CreateEvents()
    ...
    vt_map.MapTransitionEvent.Create("to mountain shrine 2nd floor South left", "data/story/ep1/mt_elbrus/mt_elbrus_shrine_2nd_s1_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine_2nd_s1_script.lua", "from_shrine_2nd_floor_grotto_left");

    vt_map.MapTransitionEvent.Create("to mountain shrine 2nd floor South right", "data/story/ep1/mt_elbrus/mt_elbrus_shrine_2nd_s1_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine_2nd_s1_script.lua", "from_shrine_2nd_floor_grotto_right");

    vt_map.MapTransitionEvent.Create("to mountain shrine stairs", "data/story/ep1/mt_elbrus/mt_elbrus_shrine_stairs_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine_stairs_script.lua", "from_shrine_2nd_floor_grotto");

    -- trap
    vt_map.ScriptedEvent.Create("start trap", "trap_start", "trap_update");

    -- When dying because of the trap
    vt_map.MapTransitionEvent.Create("Restart map", "data/story/ep1/mt_elbrus/mt_elbrus_shrine_2nd_s2_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine_2nd_s2_script.lua", GlobalManager:GetMapData():GetPreviousLocation());
