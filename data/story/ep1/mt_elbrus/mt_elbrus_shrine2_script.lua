...
function _CreateObjects()
    ...
    if (GlobalManager:GetGameEvents():GetEventValue("triggers", "mt elbrus shrine 2nd s2 trigger") == 0) then
        ...
        object:AddStillFrame("data/story/ep1/mt_elbrus/fake_wall.png");
    else
        _add_flame(1.5, 53);
    end
...
function _add_very_small_waterfall(x, y)
    ...
    -- Particle effects
    object = vt_map.ParticleObject.Create("data/visuals/particle_effects/waterfall_steam.lua", x, y - 4.0, vt_map.MapMode.GROUND_OBJECT);
...
function _CreateEvents()
    ...
    vt_map.MapTransitionEvent.Create("to mountain shrine entrance", "data/story/ep1/mt_elbrus/mt_elbrus_shrine1_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine1_script.lua", "from_shrine_main_room");

    vt_map.MapTransitionEvent.Create("to mountain shrine trap room", "data/story/ep1/mt_elbrus/mt_elbrus_shrine3_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine3_script.lua", "from_shrine_main_room");

    vt_map.MapTransitionEvent.Create("to mountain shrine enigma room", "data/story/ep1/mt_elbrus/mt_elbrus_shrine4_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine4_script.lua", "from_shrine_main_room");

    vt_map.MapTransitionEvent.Create("to mountain shrine first floor", "data/story/ep1/mt_elbrus/mt_elbrus_shrine5_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine5_script.lua", "from_shrine_main_room");

    vt_map.MapTransitionEvent.Create("to mountain shrine stairs", "data/story/ep1/mt_elbrus/mt_elbrus_shrine9_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine9_script.lua", "from_shrine_main_room");
