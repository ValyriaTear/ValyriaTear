...
function Load(m)
    ...
    -- Event Scripts
    Script:AddScript("data/story/ep1/mt_elbrus/shrine_entrance_show_crystal_script.lua");
...
function _CreateObjects()
    ...
    if (GlobalManager:GetGameEvents():GetEventValue("story", "mountain_shrine_entrance_light_done") == 1) then
        ...
        object:AddStillFrame("data/story/ep1/mt_elbrus/shrine_entrance_light.png");
    end
end
...
function _CreateEvents()
    ...
    vt_map.MapTransitionEvent.Create("to mountain shrine", "data/story/ep1/mt_elbrus/mt_elbrus_shrine2_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine2_script.lua", "from_shrine_entrance");

    vt_map.MapTransitionEvent.Create("to mountain shrine-waterfalls", "data/story/ep1/mt_elbrus/mt_elbrus_shrine2_2_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine2_script.lua", "from_shrine_entrance");

    vt_map.MapTransitionEvent.Create("to mountain bridge", "data/story/ep1/mt_elbrus/mt_elbrus_path4_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_path4_script.lua", "from_shrine_entrance");
