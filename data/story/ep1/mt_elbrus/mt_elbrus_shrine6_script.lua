...
function _CreateEvents()
    vt_map.MapTransitionEvent.Create("to mountain shrine 1st floor NW room - left door", "data/story/ep1/mt_elbrus/mt_elbrus_shrine5_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine5_script.lua", "from_shrine_first_floor_SW_left_door");

    vt_map.MapTransitionEvent.Create("to mountain shrine 1st floor NW room - right door", "data/story/ep1/mt_elbrus/mt_elbrus_shrine5_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine5_script.lua", "from_shrine_first_floor_SW_right_door");

    vt_map.MapTransitionEvent.Create("to mountain shrine 1st floor SE room - top door", "data/story/ep1/mt_elbrus/mt_elbrus_shrine7_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine7_script.lua", "from_shrine_first_floor_SW_top_door");

    vt_map.MapTransitionEvent.Create("to mountain shrine 1st floor SE room - bottom door", "data/story/ep1/mt_elbrus/mt_elbrus_shrine7_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine7_script.lua", "from_shrine_first_floor_SW_bottom_door");
