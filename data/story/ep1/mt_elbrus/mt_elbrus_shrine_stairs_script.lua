...
function _CreateCharacters()
    ...
    elseif (GlobalManager:GetMapData():GetPreviousLocation() == "from_shrine_2nd_floor_grotto") then
        hero:SetDirection(vt_map.MapMode.EAST);
        hero:SetPosition(13.5, 16.0);
    elseif (GlobalManager:GetMapData():GetPreviousLocation() == "from_shrine_third_floor") then
        hero:SetDirection(vt_map.MapMode.SOUTH);
...
function _CreateObjects()
    ...
    -- Snow effect
    vt_map.ParticleObject.Create("data/story/ep1/mt_elbrus/particles_snow_south_entrance.lua", 29, 48, vt_map.MapMode.GROUND_OBJECT);
    ...
    if (GlobalManager:GetGameEvents():GetEventValue("triggers", "mt elbrus waterfall trigger") == 1) then
        ...
        -- The poisonous scent
        Map:GetScriptSupervisor():AddScript("data/story/ep1/mt_elbrus/mt_elbrus_scent_anim.lua");
    end
end
...
function _CreateEvents()
    ...
    vt_map.MapTransitionEvent.Create("to mountain shrine 1st floor", "data/story/ep1/mt_elbrus/mt_elbrus_shrine5_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine5_script.lua", "from_shrine_2nd_floor");

    vt_map.MapTransitionEvent.Create("to mountain shrine 2nd floor", "data/story/ep1/mt_elbrus/mt_elbrus_shrine_2nd_ne_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine_2nd_ne_script.lua", "from_shrine_1st_floor");

    vt_map.MapTransitionEvent.Create("to mountain shrine 2nd floor grotto", "data/story/ep1/mt_elbrus/mt_elbrus_shrine_2nd_s2_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine_2nd_s2_script.lua", "from_shrine_stairs");

    vt_map.MapTransitionEvent.Create("to mountain shrine 3rd floor", "data/story/ep1/mt_elbrus/mt_elbrus_shrine_3rd_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine_3rd_script.lua", "from_shrine_stairs");
    ...
    vt_map.DialogueEvent.Create("Choice to enter the big door", dialogue);
    ...
    vt_map.ScriptedEvent.Create("Hide Kalya and Orlinn", "hide_kalya_and_orlinn", "");
    ...
    vt_map.ScriptedEvent.Create("The heroes won't enter event", "heroes_wont_enter", "");

    -- Chose to enter
    vt_map.ScriptedEvent.Create("Kalya laughs", "kalya_laughs", "");

    vt_map.ScriptedEvent.Create("Bronann laughs", "bronann_laughs", "");
    ...
    vt_map.ScriptedEvent.Create("Laughing event end", "laughing_event_end", "");
    ...
    vt_map.DialogueEvent.Create("Orlinn can't go away dialogue", dialogue);
    ...
    vt_map.ScriptedEvent.Create("Heroes can't go there - end", "cant_go_in_end", "");
    ...
    vt_map.ScriptedEvent.Create("Orlinn saved the heroes event end", "saved_the_heroes_end", "");
end
