...
function _CreateEvents()
    ...
    vt_map.MapTransitionEvent.Create("to mountain shrine exit", "data/story/ep1/mt_elbrus/mt_elbrus_north_east_exit_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_north_east_exit_script.lua", "from_shrine_basement");
