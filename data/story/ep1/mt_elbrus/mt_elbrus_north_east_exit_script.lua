...
function Load(m)
    ...
    Map:GetScriptSupervisor():AddScript("data/story/ep1/mt_elbrus/mt_elbrus_landscape_anim.lua");
...
function _CreateObjects()
    ...
    fire_particle_effect = vt_map.ParticleObject.Create("data/story/ep1/mt_elbrus/particles_fire_smoke.lua", 66, 24, vt_map.MapMode.GROUND_OBJECT);
...
function _CreateEvents()
    ...
    --                                 "data/story/ep1/mt_elbrus/mt_elbrus_shrine_basement_script.lua", "from_shrine_north_exit");
