...
function Load(m)
    ...
    Map:GetScriptSupervisor():AddScript("data/story/ep1/mt_elbrus/mt_elbrus_background_anim.lua");
...
function _CreateObjects()
    ...
    wind_effect1 = vt_map.ParticleObject.Create("data/story/ep1/mt_elbrus/particles_snow_pushing.lua", 34, 80, vt_map.MapMode.GROUND_OBJECT);
    wind_effect1:Stop(); -- Don't run it at start

    wind_effect2 = vt_map.ParticleObject.Create("data/story/ep1/mt_elbrus/particles_snow_pushing.lua", 45, 55, vt_map.MapMode.GROUND_OBJECT);
    wind_effect2:Stop(); -- Don't run it at start

    -- An harmless wind pusher, for once
    wind_effect3 = vt_map.ParticleObject.Create("data/story/ep1/mt_elbrus/particles_snow_pushing.lua", 87, 29, vt_map.MapMode.GROUND_OBJECT);
...
function _CreateEvents()
    vt_map.MapTransitionEvent.Create("to mountain shrine 2nd floor NE", "data/story/ep1/mt_elbrus/mt_elbrus_shrine_2nd_ne_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine_2nd_ne_script.lua", "from_shrine_2nd_floor_south");

    vt_map.MapTransitionEvent.Create("to mountain shrine 2nd floor north west", "data/story/ep1/mt_elbrus/mt_elbrus_shrine_2nd_s2_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine_2nd_s2_script.lua", "from_shrine_2nd_floor_south_west");

    vt_map.MapTransitionEvent.Create("to mountain shrine 2nd floor north east", "data/story/ep1/mt_elbrus/mt_elbrus_shrine_2nd_s2_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_shrine_2nd_s2_script.lua", "from_shrine_2nd_floor_south_east");
    ...
    vt_map.MapTransitionEvent.Create("To mountain shrine entrance", "data/story/ep1/mt_elbrus/mt_elbrus_path4_map.lua",
                                     "data/story/ep1/mt_elbrus/mt_elbrus_path4_script.lua", "from_shrine_2nd_floor_wind_trap");
end
