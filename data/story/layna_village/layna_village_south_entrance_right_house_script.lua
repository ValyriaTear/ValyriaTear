...
function _CreateEvents()
    -- Triggered events
    vt_map.MapTransitionEvent.Create("exit floor", "data/story/layna_village/layna_village_south_entrance_map.lua",
                                     "data/story/layna_village/layna_village_south_entrance_script.lua", "from right house");
end
...
function _CreateZones()
    ...
    room_exit_zone = vt_map.CameraZone.Create(26, 30, 29, 30);
end
