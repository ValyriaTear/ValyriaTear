...
namespace shader_definitions
{
    ...
    const char SOLID_COLOR_FRAGMENT[] =
        "#version 110\n"
        "\n"
        "//\n"
        "// Uses the uniform color value directly for a fragment's output.\n"
        "//\n"
        "\n"
    ...
    const char SOLID_COLOR_PER_FRAGMENT[] =
        "#version 110\n"
        "\n"
        "//\n"
        "// Interpolates vertex color for a fragment's output.\n"
        "//\n"
        "\n"
        "void main(void)\n"
        "{\n"
    ...
    const char SPRITE_COLOR_PER_VERTEX_FRAGMENT[] =
        "#version 110\n"
        "\n"
        "//\n"
        "// Samples a texture and interpolates vertex color for a fragment's output.\n"
        "//\n"
        "\n"
        "uniform sampler2D u_Texture;\n"
        "\n"
    ...
    const char SPRITE_COLOR_PER_VERTEX_GRAYSCALE_FRAGMENT[] =
        "#version 110\n"
        "\n"
        "//\n"
        "// Samples a texture, modulates vertex color, and converts to grayscale for a fragment's output.\n"
        "//\n"
        "\n"
        "uniform sampler2D u_Texture;\n"
        "\n"
