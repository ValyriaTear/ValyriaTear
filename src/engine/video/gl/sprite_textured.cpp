...
/** ****************************************************************************
*** \file    sprite_textured.cpp
*** \author  Authenticate, James Lammlein
*** \brief   Source file for buffers for a textured sprite.
*** ***************************************************************************/
...
void SpriteTextured::Draw(const std::vector<float>& vertex_positions,
