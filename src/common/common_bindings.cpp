...
// 	luabind::def("DecrementIntensity", &DecrementIntensity),
                ...
                [
                    ...
                    .enum_("constants") [
                        ...
                        luabind::value("GLOBAL_STATUS_FIRE_RAISE", GLOBAL_STATUS_FIRE_RAISE),
                        luabind::value("GLOBAL_STATUS_FIRE_LOWER", GLOBAL_STATUS_FIRE_LOWER),
                        luabind::value("GLOBAL_STATUS_WATER_RAISE", GLOBAL_STATUS_WATER_RAISE),
                        luabind::value("GLOBAL_STATUS_WATER_LOWER", GLOBAL_STATUS_WATER_LOWER),
                        luabind::value("GLOBAL_STATUS_VOLT_RAISE", GLOBAL_STATUS_VOLT_RAISE),
                        luabind::value("GLOBAL_STATUS_VOLT_LOWER", GLOBAL_STATUS_VOLT_LOWER),
                        luabind::value("GLOBAL_STATUS_EARTH_RAISE", GLOBAL_STATUS_EARTH_RAISE),
                        luabind::value("GLOBAL_STATUS_EARTH_LOWER", GLOBAL_STATUS_EARTH_LOWER),
                        luabind::value("GLOBAL_STATUS_LIFE_RAISE", GLOBAL_STATUS_LIFE_RAISE),
                        luabind::value("GLOBAL_STATUS_LIFE_LOWER", GLOBAL_STATUS_LIFE_LOWER),
                        luabind::value("GLOBAL_STATUS_DEATH_RAISE", GLOBAL_STATUS_DEATH_RAISE),
                        luabind::value("GLOBAL_STATUS_DEATH_LOWER", GLOBAL_STATUS_DEATH_LOWER),
                        luabind::value("GLOBAL_STATUS_NEUTRAL_RAISE", GLOBAL_STATUS_NEUTRAL_RAISE),
                        luabind::value("GLOBAL_STATUS_NEUTRAL_LOWER", GLOBAL_STATUS_NEUTRAL_LOWER),
