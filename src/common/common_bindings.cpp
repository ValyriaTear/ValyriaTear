...
void BindCommonCode()
{
    ...
    // ---------- Bind Global Components
    {
        ...
        [
            ...
            .def_readwrite("_phys_atk_growth", &GlobalCharacter::_phys_atk_growth)
            .def_readwrite("_mag_atk_growth", &GlobalCharacter::_mag_atk_growth)
            .def_readwrite("_phys_def_growth", &GlobalCharacter::_phys_def_growth)
            .def_readwrite("_mag_def_growth", &GlobalCharacter::_mag_def_growth)
